<div id="lightbox" class="lightbox">
    ...
    <button class="lightbox-arrow lightbox-prev" id="lbPrev">‹</button>

    <div class="lightbox-content">
        <img id="lightbox-img" src="" alt="Vista previa">
    </div>

    <button class="lightbox-arrow lightbox-next" id="lbNext">›</button>
</div>
    ...
    <div class="ve-footer-inner">
        ...
        <div class="ve-footer-card card-contacto">
            ...
            <div class="ve-contact-item">
                <img src="assets/images/mail-icon.png" class="ve-icon-img" alt="Correo">
                <a href="mailto:goyorealestate@gmail.com">goyorealestate@gmail.com</a>
            </div>

            <div class="ve-contact-item">
                <img src="assets/images/telephone-icon.png" class="ve-icon-img" alt="Teléfono">
                <div>
                    <p>(314) 355 0525</p>
                    <p>(314) 355 0026</p>
                    <p>(514) 334 1085</p>
            ...
            <div class="ve-contact-item">
                <img src="assets/images/location-icon.png" class="ve-icon-img" alt="Ubicación">
                <p>
        ...
        <div class="ve-footer-card card-social">
            ...
            <div class="ve-social-row">
                ...
                <a href="https://www.tiktok.com/@villas.eureka?_r=1&_t=ZS-91ro2KUHMM3" class="ve-social-circle" target="_blank" rel="noopener noreferrer">
                    <img src="./assets/images/tiktokicon.png" alt="TikTok">
                </a>
            </div>
